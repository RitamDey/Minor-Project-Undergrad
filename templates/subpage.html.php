    <div id="content">
        <div id="content_left">
        	<div class="content_left_section">
            	<h1>Categories</h1>
                <ul>
                    <li><a href="index.html.php">Donec accumsan urna</a></li>
                    <li><a href="index.html.php">Proin vulputate justo</a></li>
            	</ul>
            </div>
			<div class="content_left_section">
            	<h1>Bestsellers</h1>
        ...
        <div id="content_right">
            ...
            <h1><?php echo ?><span>(by author name)</span></h1>
          ...
          <h2>Read the lessons - Watch the videos - Do the exercises</h2>
            <ul>
	            <li>By <a href="#">Deke McClelland</a></li>
            	<li>Published: January 2024</li>
                <li>Pages: 498</li>
                <li>ISBN 13: 9780492518154</li>
            </ul>
